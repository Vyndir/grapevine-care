...
export type TeamInquiry = { id: string; resident_id: TeamResident["id"]; caregiver_id: string; inquiry_type: "visit_verification" | "shift_readiness" | "visit_outcome" | "handoff_approval" | "handoff_receipt"; prompt: string; status: "awaiting_coordinator_approval" | "response_received" | "resolved" | "dismissed"; response_code: "arrived_verification_failed" | "delayed" | "cannot_attend" | "no_response" | "ready_for_visit" | "visit_record_submitted" | "handoff_approved" | "handoff_received" | null; response_detail: string | null; idempotency_key: string; created_at: string; responded_at: string | null; resolved_at: string | null; };
