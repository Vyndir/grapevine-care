...
INSERT OR REPLACE INTO response_partners VALUES
  ('partner-high-country', 'High Country Community Response', 'local',
   ...
   'active', 'confirmed', 'Simulated operations check-in confirmed at the Boone Staging Hub.',
  ...
  ('partner-blue-ridge-water', 'Blue Ridge Water Network', 'regional',
   ...
   'active', 'confirmed', 'Simulated capacity report lists two mobile treatment units available.',
  ...
  ('partner-mountain-shelter', 'Mountain Shelter Alliance', 'local',
   ...
   'active', 'self_reported', 'Simulated partner update reports capacity for 60 additional residents.',
  ...
  ('partner-appalachian-medical', 'Appalachian Mobile Health Team', 'regional',
   ...
   'standby', 'confirmed', 'Simulated regional coordinator confirmed standby status.',
