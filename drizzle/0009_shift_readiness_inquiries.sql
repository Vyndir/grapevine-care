...
CREATE TABLE care_demo_team_inquiries (
  ...
  inquiry_type TEXT NOT NULL CHECK (inquiry_type IN ('visit_verification', 'shift_readiness')),
  ...
  response_code TEXT CHECK (response_code IN ('arrived_verification_failed', 'delayed', 'cannot_attend', 'no_response', 'ready_for_visit')),
